...
<html>
    ...
    <body>
        ...
        <div class="kyc-logo"></div>
            <full-box class="lite-white normal-shadow">
                <rig-2>
                    ...
                    <form autocomplete="off" method="POST">
                        ...
                        <div class="desc white-font f14 f600"><i class="fa-regular fa-pen-to-square blue-font"></i> <?php echo $lang->read('password', $config->read('app','language')); ?></div>
                        <input class="normal-shadow white-font f400 f14" name="password" type="password">

                        <div class="clear"></div>

                        <input class="lite-grey white-font normal-shadow f500 f14 no-top-bot"  type="submit" value="<?php echo $lang->read('signin', $config->read('app','language')); ?>">
                        <view-button data-action="umenu" data-json='[{"type":"quickregister"}]' class="lite-blue white-font normal-shadow f500 f14 no-top-bot "><?php echo $lang->read('signup', $config->read('app','language')); ?></view-button>
                    </form>
                </rig-2>
                <rig-2>
            ...
            <div class="copyright dark-font f600 f14"><?php echo $lang->read('copyright', $config->read('app','language')); ?></div>
        </div>
    </body>
</html>
